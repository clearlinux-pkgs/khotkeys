...
Version  : 5.24.2
Release  : 62
URL      : https://download.kde.org/stable/plasma/5.24.2/khotkeys-5.24.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.24.2/khotkeys-5.24.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.2/khotkeys-5.24.2.tar.xz.sig
...
%prep
%setup -q -n khotkeys-5.24.2
cd %{_builddir}/khotkeys-5.24.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645670765
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/khotkeys-5.24.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/khotkeys/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/khotkeys-5.24.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/khotkeys/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/khotkeys-5.24.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/khotkeys/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/khotkeys-5.24.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/khotkeys/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang khotkeys
...
/usr/lib64/libkhotkeysprivate.so.5.24.2
