...
Source0  : https://download.kde.org/stable/plasma/5.25.4/khotkeys-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/khotkeys-5.25.4.tar.xz.sig
...
%prep
%setup -q -n khotkeys-5.25.4
cd %{_builddir}/khotkeys-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659716624
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/khotkeys-%{version}/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/khotkeys/e712eadfab0d2357c0f50f599ef35ee0d87534cb
...
/usr/lib64/libkhotkeysprivate.so.5.25.4
