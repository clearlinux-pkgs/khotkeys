...
Version  : 5.16.5
Release  : 25
URL      : https://download.kde.org/stable/plasma/5.16.5/khotkeys-5.16.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.16.5/khotkeys-5.16.5.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.16.5/khotkeys-5.16.5.tar.xz.sig
Summary  : KHotKeys
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567641686
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkhotkeysprivate.so.5.16.5
