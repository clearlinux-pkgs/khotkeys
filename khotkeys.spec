...
Source0  : https://download.kde.org/stable/plasma/5.18.2/khotkeys-5.18.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.18.2/khotkeys-5.18.2.tar.xz.sig
Summary  : KHotKeys
...
%prep
%setup -q -n khotkeys-5.18.2
cd %{_builddir}/khotkeys-5.18.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582678365
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/khotkeys-5.18.2/COPYING %{buildroot}/usr/share/package-licenses/khotkeys/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/khotkeys-5.18.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/khotkeys/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
%find_lang khotkeys
...
/usr/lib64/libkhotkeysprivate.so.5.18.2
